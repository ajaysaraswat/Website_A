...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10 text-gray-800 leading-relaxed font-sans">
      ...
      <p className="mb-6">
        ...
        privacy are core to how we operate. This Privacy Policy outlines how we
      ...
      <Section title="1. Information We Collect">
        <ul className="list-disc list-inside">
          <li>
            ...
            company name — collected only when you contact us via forms, email,
            or partnerships.
          </li>
          <li>
      ...
      <Section title="4. Security">
        <p>
          As a company building digital ecosystems for tomorrow, we embed robust
          cybersecurity protocols in every layer of our systems:
        </p>
        <ul className="list-disc list-inside">
      ...
      <Section title="8. Policy Updates">
        <p>
          We may update this policy as our technologies evolve or in response to
